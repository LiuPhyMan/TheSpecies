...
import numpy as np
from myconst import fine_structure as fs_const, bohr_radius as a0, Ry_eV, nm2Hz_f, Hz2nm_f, eV2K
...
for iLvl in lvl_df.index:
    ...
    _cs[wvlnm_seq<lvl_df.loc[iLvl, "Eth_nm"]] = _const/lvl_df.loc[iLvl, "Qn"]*sqrt(Ry_eV/lvl_df.loc[iLvl, 'Eth_eV'])*\
        (wvlnm_seq[wvlnm_seq<lvl_df.loc[iLvl, "Eth_nm"]]/lvl_df.loc[iLvl, 'Eth_nm'])**3
    norm_cs_seq = norm_cs_seq + _cs*lvl_df.loc[iLvl, 'g']*exp(-lvl_df.loc[iLvl, "E"]*eV2K/T_K)